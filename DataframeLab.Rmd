...
grants_2010_count <- length(grants$start_year[grants$start_year == 2010])
...
person_expenditure <- pivot_longer(data=person_expenditure, cols=Category, names_to="category", values_to="expenditure")
print(glimpse(person_expenditure))
